...
import { Flower, Trees, Citrus, Sparkles, Sunrise, Wind, Users, Gem, Grape, Flame, Flower2, Leaf, Sprout, TreePine, Apple, Bean } from "lucide-react";
  ...
  const filteredPerfumes =
    selectedFilters.length === 0
      ...
      : perfumes.filter((perfume) =>
          selectedFilters.some((filter) => perfume.category.includes(filter))
        );
